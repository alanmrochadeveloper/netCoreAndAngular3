...
@Injectable()// this says it is dependency injection
export class Repository{
    ...
    getSuppliers(){
        this.http.get<Supplier[]>( suppliersUrl).subscribe(sups => this.suppliers = sups);
    }
    createProduct(prod: Product){
        ...
        .subscribe(id => {prod.productId = id;
    ...
    replaceProduct(prod: Product){
        let data ={
            ...
            description: prod.description,
            price: prod.price,
            supplier: prod.supplier ? prod.supplier : 0
        };
